...
export class fetchEstudianteBeca
{
    ...
    static async insertarEstudianteBecadoEnBDD(objeto) {
        ...
        try {
            ...
            let solicitud = await fetch(`${this.url}?ruta=estudiantebeca&accion=insertarEstudianteBecado&actor=secreta
                rio`, options);
    ...
    static async actualizarEstudianteBecadoEnBDD(objeto) {
        ...
        try {
            ...
            let solicitud = await fetch(`${this.url}?ruta=estudiantebeca&accion=actualizarEstudianteBecado&actor=secretario`, options);
            let respuesta = await solicitud.text(); console.log(respuesta)
