...
export class fetchBeca
{
    ...
    static async insertarBecaEnBDD(objeto) {
        try {
            let solicitud = await fetch(`${this.url}?ruta=beca&accion=insertarBeca&actor=secretario`, {
    ...
    static async actualizarBecaEnBDD(objeto) {
        try {
            let solicitud = await fetch(`${this.url}?ruta=beca&accion=actualizarBeca&actor=secretario`, {
