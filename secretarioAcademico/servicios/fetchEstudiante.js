...
export class fetchEstudiante
{
    ...
    static async insertarEstudianteEnBDD(objeto) {
        try {
            let solicitud = await fetch(`${this.url}?ruta=estudiante&accion=insertarEstudiante&actor=secretario`, {
    ...
    static async actualizarEstudianteEnBDD(objeto) {
        try {
            let solicitud = await fetch(`${this.url}?ruta=estudiante&accion=actualizarEstudiante&actor=secretario`, {
